...
contract LendingTest is Test {
  ...
  // supply test
    ...
    function test_supply() public {
      ...
      assertEq(
              assetToken.balanceOf(address(pool)), 
              supplyAmount, 
    ...
    function test_BorrowInterestAccrual() public {
        ...
        assertApproxEqRel(
            debt, 
            borrowAmount + expectedInterest, 
            0.01e18,
            "Borrow interest mismatch"
        );
    }
...
if(aliceBalance > poolLiquidity) {
    ...
    function test_LiquidationProtectsLenders() public {
        ...
        assertTrue(
            assetToken.balanceOf(alice) >= 10_000 * 10**18,
            "Alice should be protected"
        );
    }
